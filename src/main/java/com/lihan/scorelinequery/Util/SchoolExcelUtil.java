...
public class SchoolExcelUtil {
    public static Set<School> excelToGetSchool(InputStream inputStream) {
...
//            System.out.println("总列数有多少列" + colLength);
            ...
            for (int a = 1; a < rowLength; a++) {
                ...
                for (int b = 0; b < colLength; b++) {
                    ...
                    switch (b){
                        case 0:
                            school.setSchool_name(stringCellValue);
                            break;
                        case 1:
                            school.setProvince_name(stringCellValue);
                            break;
                    }
                }
